...
{
    public SimpleBlittableRecordStruct Value { get; init; }

    public SimpleBlittableRecordStruct? OptionalValue { get; init; }

    public SimpleBlittableRecordStruct[]? Values { get; init; }
}
