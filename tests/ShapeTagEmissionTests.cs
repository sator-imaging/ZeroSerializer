...
public class ShapeTagEmissionTests
{
    ...
    public void ShapeTagIsCommentedOutByDefault()
    {
        ...
        Assert.Contains("    ///// A structural signature that describes the layout of the serialized type and any struct-typed properties.", generatedView);
        Assert.Contains("    ///// </summary>", generatedView);
        Assert.Contains("    //public const string ShapeTag = \"v1/{int}\";", generatedView);
        Assert.Contains("    /// <summary>", generatedView);
        Assert.Contains("    /// A hash of the structural signature that describes the layout of the serialized type and any struct-typed properties.", generatedView);
        Assert.Contains("    /// </summary>", generatedView);
