...
public sealed class SerializationTests
{
    ...
    public void VariableDataRoundTrip()
    {
        ...
        TestAssert.Equal(source.Child.Identifier, view.Child?.Identifier ?? -1, nameof(VariableRecordView.Child.Identifier));
        TestAssert.Equal(source.Child.State, view.Child?.State ?? ByteState.None, nameof(VariableRecordView.Child.State));
